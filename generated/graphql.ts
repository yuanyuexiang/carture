...
export type GetUserBoutiqueQueryVariables = Exact<{
  userId: Scalars['ID']['input'];
}>;


export type GetUserBoutiqueQuery = { __typename?: 'Query', boutiques: Array<{ __typename?: 'boutiques', id: string, name?: string | null, address?: string | null, main_image?: string | null, images?: any | null, stars?: number | null, status?: string | null, date_created?: any | null, date_updated?: any | null }> };
 ...
 * });
 */
export function useGetUserBoutiqueQuery(baseOptions: ApolloReactHooks.QueryHookOptions<GetUserBoutiqueQuery, GetUserBoutiqueQueryVariables> & ({ variables: GetUserBoutiqueQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return ApolloReactHooks.useQuery<GetUserBoutiqueQuery, GetUserBoutiqueQueryVariables>(GetUserBoutiqueDocument, options);
      }
export function useGetUserBoutiqueLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetUserBoutiqueQuery, GetUserBoutiqueQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useLazyQuery<GetUserBoutiqueQuery, GetUserBoutiqueQueryVariables>(GetUserBoutiqueDocument, options);
        }
export function useGetUserBoutiqueSuspenseQuery(baseOptions?: ApolloReactHooks.SkipToken | ApolloReactHooks.SuspenseQueryHookOptions<GetUserBoutiqueQuery, GetUserBoutiqueQueryVariables>) {
          const options = baseOptions === ApolloReactHooks.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return ApolloReactHooks.useSuspenseQuery<GetUserBoutiqueQuery, GetUserBoutiqueQueryVariables>(GetUserBoutiqueDocument, options);
        }
...
export type GetUserBoutiqueQueryResult = ApolloReactCommon.QueryResult<GetUserBoutiqueQuery, GetUserBoutiqueQueryVariables>;
